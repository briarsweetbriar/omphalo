Omphalo.ComplimentaryView = Em.View.extend
    ...
    $.getJSON "/compliments", {rand: @get('rand')}, (response) =>
      ...
      if response.uploads?
        ...
        for upload in response.uploads
          normalized = serializer.normalize(Omphalo.Upload, upload)
      ...
      if response.officials?
        ...
        for official in response.officials
          normalized = serializer.normalize(Omphalo.Official, official)
      ...
      if response.organizations?
        ...
        for organization in response.organizations
          normalized = serializer.normalize(Omphalo.Organization, organization)
      ...
      if response.products?
        ...
        for product in response.products
          normalized = serializer.normalize(Omphalo.Product, product)
